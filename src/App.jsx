...
// STYLES - RESTORED TO THE VERSION THAT WORKS FOR DESKTOP
const styles = {
...
const MainView = ({ onAnalyze, onTickersChange, tickers, loading, error, results, onSelectStock }) => (
    <div className="main-view-container" style={{display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%'}}>
        <h1 style={styles.header}>AI Powered Pocket Analyst</h1>
        <div style={styles.inputPanel}>
            <form style={styles.form} onSubmit={onAnalyze}>
