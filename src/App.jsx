...
// STYLES - RESTORED TO YOUR ORIGINAL, WORKING VERSION FOR DESKTOP
const styles = {
...
// ALL PANEL COMPONENTS ARE UNCHANGED AND WORKING
...
const DetailedView = ({ stock, onBack }) => {
  ...
  return (
    <div style={{...styles.container, padding: 0}}>
      ...
      {/* DESKTOP VIEW (Original, working layout) */}
      ...
      {/* MOBILE VIEW (New, creative layout) */}
