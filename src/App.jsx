...
// STYLES - YOUR EXACT STYLES OBJECT FOR THE DESKTOP VIEW
const styles = {
...
// ALL PANEL COMPONENTS ARE THE ORIGINAL, WORKING VERSIONS
...
// --- HYBRID DETAILED VIEW COMPONENT ---
const DetailedView = ({ stock, onBack }) => {
  // State and data for the mobile view
  ...
  return (
    <>
      {/* DESKTOP VIEW (The original code you provided) */}
      ...
      {/* MOBILE VIEW (The new creative layout) */}
